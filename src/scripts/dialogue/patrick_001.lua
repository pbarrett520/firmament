return {
  ...
  ["a273cb75-765a-4b6a-96b0-9c81b8922998"] = {
    ...
    is_entry_point = false,
    kind = "Text",
    text = "Prism walks over to you, unconcerned. The back of the metal table articulates upward. He picks you up from under the arms and sits you up.",
  ...
  ["ce090d7e-802f-4f25-8d09-04fe7f3d6cb3"] = {
    ...
    is_entry_point = false,
    kind = "Text",
    text = "this is as far as i've gotten",
